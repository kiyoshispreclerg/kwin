...
Atoms::Atoms()
    ...
    , dpi(QByteArrayLiteral("DPI"))
    , x_density_scale(QByteArrayLiteral("_X_DENSITY_SCALE"))
    , x_density_requested(QByteArrayLiteral("_X_DENSITY_REQUESTED"))
    , x_density_pixmap(QByteArrayLiteral("_X_DENSITY_PIXMAP"))
